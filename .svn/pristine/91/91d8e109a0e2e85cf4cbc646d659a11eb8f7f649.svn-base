...
namespace Lab01AndresTangarife
{
    ...
    public partial class Tile : Form
    {
        ...
        public Tile()
        {
            ...
            _Secretelbl.MouseEnter += Tile_MouseEnter;  // Event handler to change tile text when cheat mode is activated
            _Secretelbl.MouseLeave += Tile_MouseLeave;  // Set tile Tex as Title everytime mouse leaves the tile
        }
        /// <summary>
        ...
        {
            _guessClick?.Invoke(this, e); // Fire the _guessClick event
        }
        ...
        private void _timer_Tick(object sender, EventArgs e)
        {
            ...
            _turnComplete?.Invoke(this, EventArgs.Empty); // Set turn as complete
        }
        /// <summary>
        ...
        public void TileTurnHandler(TileState state)
        {
            ...
            {
                _turnComplete?.Invoke(this, EventArgs.Empty); // Fire the _turnComplete event
